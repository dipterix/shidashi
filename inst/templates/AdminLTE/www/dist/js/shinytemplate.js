...
class ShinyTemplates {
  ...
  // utils, shiny, ...
  async matchSelector(el, selector, next) {
    const $el = $(el);
    const $els = $(selector);
...
const $body = $("body");
const $aside = $("aside");
const $navIfarme = $(".navbar-nav-iframe");
const $iframeWrapper = $(".content-wrapper.iframe-mode");
const switchThemeMode = (mode) => {

  const dark_mode = $body.hasClass("dark-mode");
  const $iframes = $iframeWrapper.find("iframe");

  if( dark_mode && mode === "dark" ){ return; }
  if( !dark_mode && mode === "light" ){ return; }

  if( dark_mode ){
    // if dark_mode, switch to light mode
    $body.removeClass("dark-mode");
    $aside.removeClass("sidebar-dark-primary")
          .addClass("sidebar-light-primary");
    $navIfarme.removeClass("navbar-dark")
              .addClass("navbar-light");
  } else {
    $body.addClass("dark-mode");
    $aside.removeClass("sidebar-light-primary")
          .addClass("sidebar-dark-primary");
    $navIfarme.removeClass("navbar-light")
              .addClass("navbar-dark");
  }

};
window.ssss = switchThemeMode;
