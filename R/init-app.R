...
#'
#' @param env the environment in which to store the global-stores variable;
#'   defaults to the caller's environment.
#'
#' @return The global stores environment (invisibly).
#'
#' @details
...
#'     Shiny session token, storing \verb{MCP} session entries.}
...
#' Retrieve the shidashi global stores environment
#'
#' @description
#' Looks up the global stores \code{.__shidashi_globals__.} by walking the environment chain
...
#'
#' @return The global stores environment created by \code{\link{init_app}()}.
